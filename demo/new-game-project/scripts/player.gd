...
const HOOK_SHOOT_SPEED = 1500.0
const MAX_HOOK_DISTANCE = 600.0
const REEL_IN_SPEED = 300.0  # How fast the rope shortens
const MIN_ROPE_LENGTH = 50.0  # Minimum rope length

var gravity = ProjectSettings.get_setting("physics/2d/default_gravity")
var is_hooked = false
var is_hook_shooting = false
var hook_velocity = Vector2.ZERO
var hook_start_pos = Vector2.ZERO
